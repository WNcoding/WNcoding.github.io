import{_ as n,o as i,c as e,a as s}from"./app-891ae1ba.js";const d={},l=s(`<h2 id="菱形个数" tabindex="-1"><a class="header-anchor" href="#菱形个数" aria-hidden="true">#</a> 菱形个数</h2><p>给定正整数X、Y，算出同时满足下列3个条件的所有菱形个数:</p><p>1.菱形存在正面积。</p><p>2.菱形每个顶点的横坐标xi为0≤xi≤X的整数，纵坐标yi为0≤yi≤Y的整数。</p><p>3.菱形的对角线平行于坐标轴。</p><p><strong>输入描述</strong></p><p>输入为一行，包含两个整数x和v，满足(1≤x, Y≤300)</p><p><strong>输出描述</strong></p><p>输出一个数,表示满足条件的所有菱形个数</p><p><strong>示例1</strong></p><p>输入</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>2 2
